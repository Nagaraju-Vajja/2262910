...
public class ControllerExceptionHandlerTest implements TestContextUtil, ProblemUtil,
    ServiceContextUtil {
	...
	public void testHandleExceptionNormal() {
		...
		try {
			controllerExceptionHandler.handleException(joinPoint, exception);
		} catch (Exception e) {
	...
	public void testHandleExceptionThrowableProblem() {
		...
		try {
			controllerExceptionHandler.handleException(joinPoint,problem);
		} catch (Exception e) {
