...
@SpringBootTest(classes = EventOnsuccessPublisherImpl.class)
public class EventOnsuccessPublisherImplTest implements TestContextUtil, ServiceContextUtil, OrdercollectorchestratorUtil {

	@Autowired
	private IEventOnsuccessPublisher eventlogPublish;
	...
	public void publishTest() throws ExecutionException, InterruptedException {
		...
		String result = eventlogPublish.publishMessage("MessageString", getDefaultMessageHeaders());
