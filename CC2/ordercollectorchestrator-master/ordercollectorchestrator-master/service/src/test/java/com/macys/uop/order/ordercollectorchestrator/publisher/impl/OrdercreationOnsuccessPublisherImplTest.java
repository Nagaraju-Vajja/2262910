...
@SpringBootTest(classes = OrdercreationOnsuccessPublisherImpl.class)
public class OrdercreationOnsuccessPublisherImplTest implements TestContextUtil, ServiceContextUtil,
    OrdercollectorchestratorUtil {

	@Autowired
	private IOrdercreationOnsuccessPublisher ordercreationOnsuccessPublisher;
	...
	public void publishTest() throws ExecutionException, InterruptedException {
		...
		String result = ordercreationOnsuccessPublisher.publishMessage("MessageString", getDefaultMessageHeaders());
